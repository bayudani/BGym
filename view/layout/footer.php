  ...
  <div class="mx-auto max-w-screen-xl px-4 py-16 sm:px-6 lg:px-8">
    <div class="lg:flex lg:items-start lg:gap-8">
      <div class="text-teal-600">
        <img class="h-10" src="./asset/img/logo.png" alt="">
      </div>

      <div class="mt-8 grid grid-cols-2 gap-8 lg:mt-0 lg:grid-cols-5 lg:gap-y-16">
        <div class="col-span-2">
          <div>
            <h2 class="text-2xl font-bold text-white">BroGym</h2>
        ...
        <div class="col-span-2 sm:col-span-1">
          ...
          <ul class="mt-6 space-y-4 text-sm">
            <li>
              <a href="#" class="text-white transition hover:opacity-75"> Memebrship </a>
            </li>

            <li>
              <a href="#" class="text-white transition hover:opacity-75"> Produk </a>
            </li>

            <li>
              <a href="#" class="text-white transition hover:opacity-75"> Artikel </a>
            </li>
        ...
        <div class="col-span-2 sm:col-span-1">
          <p class="font-medium text-white">Membership</p>

          <ul class="mt-6 space-y-4 text-sm">
            <li>
              <a href="#" class="text-white transition hover:opacity-75"> 1 bulan </a>
            </li>

            <li>
              <a href="#" class="text-white transition hover:opacity-75"> 3 bulan </a>
            </li>

            <li>
              <a href="#" class="text-white transition hover:opacity-75"> 6 bulan </a>
            </li>
          </ul>
        </div>

        <!-- <div class="col-span-2 sm:col-span-1">
          <p class="font-medium text-white">P</p>
    ...
    <div class="mt-8 border-t border-gray-100 pt-8">
      <div class="sm:flex sm:justify-between">
        <p class="text-xs text-gray-500">&copy; 2024. Bayu dani kurniawan. All rights reserved.</p>
